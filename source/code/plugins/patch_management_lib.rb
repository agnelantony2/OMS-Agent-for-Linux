...
class LinuxUpdates
    ...
    def process_yum_record(record, tag, host, time)
        ...
        # a: 'libXft-2.3.2-1.el6.x86$-1.28-12.el6.x86_64' -- starts with package name. and no dash in the middle
        # b: '32:bind-utils-9.9.4-38.el7_3.1.x86_64' -- starts with 'digits:'
        # c: 'sssd-client-1.14.0-43.el7_3.11.x86_64' -- starts with package name and has dash in the middle:
        package_name_sections = record["package-name"].split(/-\d/)
        package_name = nil;
